...
socialShare:
  twitter: "Discover how @BlazorSignalStore delivers 50% fewer re-renders compared to Microsoft's Container State pattern 🚀 #Blazor #StateManagement #ReactiveProgramming"
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1 class="display-4 text-center mb-4">📦 Container State Pattern Demo</h1>
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">📊 Form Progress</h5>
                </div>
                <div class="card-body">
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1 class="display-4 text-center mb-4">⚡ Signal Form Demo</h1>
            <p class="lead text-center mb-5">
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0">📊 Form Progress (Reactive)</h5>
                </div>
                <div class="card-body">
                    <div class="progress mb-2" style="height: 25px;">
